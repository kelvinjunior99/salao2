	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
				...
				<div class="col-auto">
					<div class="page-utilities">
						<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							<div class="col-auto">
								<form class="table-search-form row gx-1 align-items-center" method="post" action="resultado-stock">
									<div class="col-auto">
										<input type="text" id="search-orders" name="pesquisar" required class="form-control search-orders" placeholder="Pesquisar no stock">
									</div>
									<div class="col-auto">
			...
			<nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
				<a class="flex-sm-fill nav-link active" id="orders-all-tab" data-bs-toggle="tab" role="tab" aria-controls="orders-all" aria-selected="true" style="text-align: left; cursor: normal; text-transform: uppercase;">Stock de Postiços</a>
			...
			<div class="tab-content" id="orders-table-tab-content">
									...
									<tbody>
										...
										<tr>
											<?php foreach ($dados as $dado) { ?>
												...
												<td class="cell"><a href="editar-postico&id=<?php echo $dado['id']; ?>"><i class="fa fa-edit fa-2x" aria-hidden="true"></i></a></td>
                ...
                <ul class='pagination justify-content-center'>";
                    ...
                    <li class='page-item'>
                    <a class='page-link' href='stock&pagina=$pag_ant' tabindex='-1'>$pag_ant</a></li>";
						}
					}
                    ...
                    <a class='page-link' href='stock&pagina=$pag_dep'>$pag_dep</a> </li>
                    ";
						}
					}

					echo "<li class='page-item'><a class='page-link' href='stock&pagina=$quantidade_pg'>Ultima</a></li>";
					echo "
                </ul>
                </nav>";
