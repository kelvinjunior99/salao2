	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Cadastrar funcionario</h1>
				</div>
			...
			if (isset($_GET['erro_nome'])) {   ?>
				...
				<div class="alert alert-danger alert-dismissible fade show" role="alert">
					<strong>Não foi possivel cadastrar funcionario</strong> <?php echo "já existe produto com este nome!";  ?>
			...
			<form method="post" action="./controller/cadastrar/pro-funcio.php">
				<div class="form-floating mb-3">
					<input type="text" class="form-control" name="nome" id="nome" placeholder="name@example.com">
					<label for="floatingInput">Nome</label>
				</div>
				<div class="form-floating mb-3">
					<input type="text" class="form-control" name="morada"  id="preco" placeholder="Password">
					<label for="floatingPassword">Morada</label>
				</div>

				<div class="form-floating mb-3">
					<input type="number" min="0" id="qnt" name="telefone" class="form-control" placeholder="name@example.com">
